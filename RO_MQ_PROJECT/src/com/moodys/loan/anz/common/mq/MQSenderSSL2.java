...
public class MQSenderSSL2 {
    private static final Logger logger = LoggerFactory.getLogger(MQSenderSSL2.class);
    ...
    public MQStatus send(String text, MQConfiguration config) {
        ...
        // SSL_RSA_WITH_3DES_EDE_CBC_SHA Y => TRIPLE_DES_SHA_US
        ...
        try {
            ...
            ks.load(new FileInputStream("C://Projects/RO_MQ/jmsKeyStore.jks"), pwd.toCharArray());
            ...
            logger.info("JMS SSL client connection started!");
            connection.close();
